...
| F — Review + deploy + verify + notify    | ◷ in progress                  | full gate at HEAD GREEN (types/lint/units/build/e2e-v3 31/31/standalone 10/10); whole-sprint codex verdict: SHIP (991 server + 465 webview-v3 re-verified). Now: push → deploy → live verify → Bark → handoff                                                                                                         |
