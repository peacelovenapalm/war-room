...
import { claudeProvider, copyHookScript, hookProviderRegistry } from './providers/index.js';
...
async function main(): Promise<void> {
  ...
  try {
    ...
    const runtime = new AgentRuntime(store, claudeProvider, hookProviderRegistry);
