...
| `props.furniture_core.sheet.png`      | 4 first-paint furniture props × 4 rotations (N/E/S/W), alpha + baked contact shadow                                                                                |
| `props.furniture_extra.sheet.png`     | 6 deferred furniture props × 4 rotations, alpha + baked contact shadow                                                                                             |
...
| `characters.staff_<outfit>.sheet.png` | one outfit × {walk×4, sit, type×2, blocked} × 4 rotations, same rig/lighting as props                                                                              |
